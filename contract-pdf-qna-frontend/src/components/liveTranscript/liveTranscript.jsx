    ...
    >
      ...
      <aside className="lt_left_ccp">
        <div className="live_transcript_header lt_left_ccp_header">
          ...
          <div
            className={`lt_conn_pill ${
              isConnected
                ? "lt_conn_pill--connected"
                : "lt_conn_pill--disconnected"
            }`}
          >
                    ...
                    <div key={cardKey} className={priorityClass}>
                      ...
                      {c?.evidence ? (
                        <div className="lt_suggestion_evidence">
                          <span className="lt_evidence_label">
                            Triggered by:
                          </span>
                          <span className="lt_evidence_text">
                            &quot;{c.evidence}&quot;
                          </span>
                        </div>
                      ) : null}
