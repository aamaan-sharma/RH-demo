...
export const TRANSCRIPTS_API_BASE_URL = "http://localhost:8001";
...
export const CCP_URL = import.meta.env.VITE_CCP_URL;

export const REGION = import.meta.env.VITE_REGION;

export const BACKEND_BASE = "http://localhost:8001";
